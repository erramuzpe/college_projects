%umbral(1)= umbral('00.bmp')  con REF=1
%umbral(2)= umbral('00.bmp')  con REF=2

function optimo = umbral2(imagen,umbral) %umbral es un vector de umbrales
    img = imread(imagen);
