...
{algoritmo} 		{return tok_algoritmo;printf("leido algoritmo\n");}
...
{caracter}		{return tok_caracter;}
{id}			{strcpy(yytext,yylval.campo_id);
			printf("leido identificador %s\n",yytext);
			return tok_id;}
. 			{printf("waka\n",yytext);}
<<EOF>>			return 0;
