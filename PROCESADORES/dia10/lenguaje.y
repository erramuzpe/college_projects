...
desc_algoritmo:	tok_algoritmo tok_id tok_punto_y_coma cabecera_alg bloque_alg tok_falgoritmo {}
		;
...
NLI:		tok_id tok_dos_puntos tipo {
					      insertarNodo(&t,$1,cont);
					      cont++;
					      modificarTipo(&t,$3,cont);
					      $$ = $3;
					   }
		| tok_id tok_coma NLI {
					      insertarNodo(&t,$1,cont);
...
exp:		exp tok_mas exp {
				      ...
				      cont++;
				      int cuadrupla[4] = {SUMA,$1.place->id,$3.place->id,T->id};
				      gen(&c,cuadrupla);
				      $$.tipo = ENTERO;
				}		  
		| exp tok_menos exp {
				      ...
				      modificarTipo(&t,ENTERO,cont);
				      cont++;
				      int cuadrupla[4] = {RESTA,$1.place->id,$3.place->id,T->id};
				      gen(&c,cuadrupla);
				      $$.tipo = ENTERO;
				    }
		| exp tok_por exp {
				      ...
				      modificarTipo(&t,ENTERO,cont);
				      cont++;
				      int cuadrupla[4] = {MULTI,$1.place->id,$3.place->id,T->id};
				      gen(&c,cuadrupla);
				      $$.tipo = ENTERO;
				  }
		| exp tok_div exp {
				      ...
				      modificarTipo(&t,ENTERO,cont);
				      cont++;
				      int cuadrupla[4] = {DIVI,$1.place->id,$3.place->id,T->id};
				      gen(&c,cuadrupla);
				      $$.tipo = ENTERO;		      
				  }
		| tok_menos_unario exp {
				      ...
				      modificarTipo(&t,ENTERO,cont);
				      cont++;
				      int cuadrupla[4] = {MENOS_UNARIO,$2.place->id,-27,T->id};
				      gen(&c,cuadrupla);
				      $$.tipo = ENTERO;					
				       }
		...
		| exp tok_mod exp {
				      ...
				      modificarTipo(&t,ENTERO,cont);
				      cont++;
				      int cuadrupla[4] = {MOD,$1.place->id,$3.place->id,T->id};
				      gen(&c,cuadrupla);
				      $$.tipo = ENTERO;      
				  }
		;
